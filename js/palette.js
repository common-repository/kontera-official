...
myPalette.style.color = myValue.value;
...
function set_colorpreview() {

myValue = document.getElementById('color_value');
myPreview = document.getElementById('color_preview');
document.getElementById('color_preview').style.color = myValue.value;
}
